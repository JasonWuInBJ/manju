...
export async function GET(request: Request, { params }: Props) {
  ...
  try {
    ...
    console.log('[Character Image] 查询任务状态', { taskId })
    ...
    console.log('[Character Image] 任务状态响应', {
      taskId,
    ...
    if (taskStatus === 'SUCCESS') {
      ...
      console.log('[Character Image] 获取任务结果', { taskId })
      ...
      console.log('[Character Image] 任务结果响应', {
        taskId,
      ...
      console.log('[Character Image] 图片生成成功', { imageUrl })
    ...
    console.error('[Character Image] 查询任务状态异常', error)
    return NextResponse.json(
      { error: '查询任务状态失败' },
      { status: 500 }
    )
